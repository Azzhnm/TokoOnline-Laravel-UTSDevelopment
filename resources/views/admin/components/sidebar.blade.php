<aside
    class="sidebar navbar navbar-expand-lg d-flex flex-column gap-4 align-content-lg-center mx-2 my-2 rounded" style="background-color: #E78895">
    <h5 class="navbar-brand ">Zhiee Fashion
